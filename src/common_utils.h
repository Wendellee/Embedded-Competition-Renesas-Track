...
// enable debug messages over RTT with the following define
#define RTT_DEBUG_ON
...
#define MODULE_NAME             "icm42670 PMOD demo"
#define BANNER_INFO             "\r\n********************************************************************************"\
...
#define APP_MESSAGE(str)        (SEGGER_RTT_WriteString(SEGGER_INDEX,str))
