...
//            xprintf("x:%.4fg\ty:%.4fg\tz:%.4fg\r\n", pADXL345->value.x, pADXL345->value.y, pADXL345->value.z);
            ...
            count++;
                ...
                AIC = amr_predict(inputData);
                /* Decode classification event using class names */
                switch(AIC){
                 case(amr_no_results):
                    Serial_Printf(g_uart7.p_ctrl,"Predicted Class: no_results\n");
                    break;
                case(amr_DROP):
                    Serial_Printf(g_uart7.p_ctrl,"Predicted Class: DROP\r\n");
                    break;
                case(amr_MOVE):
                    Serial_Printf(g_uart7.p_ctrl,"Predicted Class: MOVE \r\n");
                    break;
                case(amr_NORMAL):
                    Serial_Printf(g_uart7.p_ctrl,"Predicted Class: NORMAL \r\n");
                    break;
                };
            #endif
            count = 0;
